  ...
  return (
    <div>
      ...
      <div class='p-4 flex flex-row  justify-around'>
        <div class='flex w-1/2 p-8 m-2  gap-[16px] flex-col border-[1px] border-[#ABAFB1] rounded-lg'>
        <span class=' text-xl font-bold'> Approver </span>
        <span class='text-start  text-[#ABAFB1] font-medium text-sm'>Department</span>
        <div class='flex flex-start felx-row'>
    ...
    <div class='p-2'><span class='p-2'><AccountCircleIcon/></span>{element} </div>
  ))}
        ...
        <div class='flex w-1/2 p-8 m-2 gap-[16px] flex-col border-[1px] border-[#ABAFB1] rounded-lg'>
        <span class=' text-xl font-bold'> Verifier</span>
        <span class='text-start  text-[#ABAFB1] font-medium text-sm'>Department</span>
        <div class='flex flex-start felx-row'>
        {institutes[clickedButton]?.dept.map((element, id) => (
    <button
    ...
    <div class='p-2'><span class='p-2'><AccountCircleIcon/></span>{element} </div>
      ...
      <div class='px-6'>
      <div class='flex w-full p-4 gap-[16px] flex-col border-[1px] border-[#ABAFB1] rounded-lg'>
        <span class=' text-xl font-bold'> Initiators </span>
        <span class='text-start  text-[#ABAFB1] font-medium text-sm'>Department</span>
        <div class='flex flex-start felx-row'>
        {institutes[clickedButton]?.dept.map((element, id) => (
    <button
